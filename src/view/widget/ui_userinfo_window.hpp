/********************************************************************************
** Form generated from reading UI file 'userinfo_windowaYFOfC.ui'
**
...
#ifndef USERINFO_WINDOWAYFOFC_H
#define USERINFO_WINDOWAYFOFC_H
...
public:
    ...
    void setupUi(QWidget* userinfo_windowui)
    {
        ...
        functionButton->setGeometry(QRect(110, 430, 161, 31));
        quitButton = new QPushButton(userinfo_windowui);
        quitButton->setObjectName("quitButton");
        quitButton->setGeometry(QRect(270, 0, 31, 24));
        quitButton->setStyleSheet(QString::fromUtf8("background-color: rgb(186, 186, 186);border-radius:16px;"));
