/********************************************************************************
** Form generated from reading UI file 'addfriendformiphsGR.ui'
**
...
#ifndef ADDFRIENDFORMIPHSGR_H
#define ADDFRIENDFORMIPHSGR_H
...
public:
    ...
    void setupUi(QWidget* AddFriendForm)
    {
        ...
        background->setStyleSheet(QString::fromUtf8("background-color: rgb(225, 255, 202);"));
