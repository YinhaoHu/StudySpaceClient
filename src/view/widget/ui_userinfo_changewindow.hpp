/********************************************************************************
** Form generated from reading UI file 'userinfo_change_windowyGoDvw.ui'
**
...
#ifndef USERINFO_CHANGE_WINDOWYGODVW_H
#define USERINFO_CHANGE_WINDOWYGODVW_H
...
public:
    ...
    void setupUi(QWidget* userinfo_change_windowui)
    {
        ...
        userinfo_change_windowui->resize(300, 500);
        ...
        quitButton->setGeometry(QRect(260, 5, 31, 20));
...
#endif // USERINFO_CHANGE_WINDOWYGODVW_H
