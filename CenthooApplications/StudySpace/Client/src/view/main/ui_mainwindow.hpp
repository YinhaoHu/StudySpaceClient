/********************************************************************************
** Form generated from reading UI file 'mainwindowYOdqYS.ui'
**
...
#ifndef MAINWINDOWYODQYS_H
#define MAINWINDOWYODQYS_H
...
public:
    ...
    void retranslateUi(QWidget* mainwindowui)
    {
        ...
        label->setText(QCoreApplication::translate("mainwindowui", "<html><head/><body><p align=\"center\"><span style=\" font-size:22pt; font-weight:700; font-style:italic;\">Study Space</span></p></body></html>", nullptr));
